...
public interface MintPermissionsController {
     ...
     */
    public fun observe(permission: MintPermission): Flow<MintPermissionStatus>
     ...
     */
    public fun observe(permissions: List<MintPermission>): Flow<List<MintPermissionStatus>>
     ...
     */
    public fun observeAll(): Flow<List<MintPermissionStatus>>
     ...
     * @return flow of single [MintPermissionStatus]. If not found in declared permissions, returns [MintPermissionStatus.NotFound]
     */
    public suspend fun get(permission: MintPermission): MintPermissionStatus
     ...
     * @return flow of list [MintPermissionStatus]. If not found in declared permissions, returns [MintPermissionStatus.NotFound]
     */
    public suspend fun get(permissions: List<MintPermission>): List<MintPermissionStatus>
     ...
     */
    public suspend fun getAll(): List<MintPermissionStatus>
     ...
     */
    public suspend fun request(permission: MintPermission): MintPermissionResult
     ...
     */
    public suspend fun request(permissions: List<MintPermission>): List<MintPermissionResult>
}